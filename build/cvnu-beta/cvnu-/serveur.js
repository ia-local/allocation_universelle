...
const { calculateUtmi, calculateDashboardInsights, COEFFICIENTS } = require('../cvnu/server_modules/utms_calculator');
const { MODEL_QUALITY_SCORES } = require('../cvnu/server_modules/model_quality_config'); // Assurez-vous que ce fichier existe

// NOUVEAU/RÉINTÉGRATION: Modules spécifiques au générateur de CV (section "Analyser le Texte")
const { analyzeRawConversation } = require('../cvnu/src/analyse_soup'); // Assurez-vous que ce fichier existe
...
const { analyzeConversationCognitively } = require('../cvnu/src/llama_cognitive_analysis'); // MOCK ou votre implémentation
const { generateCurriculumVitae } = require('../cvnu/src/generateCV'); // MOCK ou votre implémentation
const { valorizeSkillsWithGroq } = require('../cvnu/src/groq_cv_analyse'); // Le fichier que vous aviez

// NOUVEAU: Importation du module d'analyse CV pour le chat
const { generateProfessionalSummary } = require('../cvnu/server_modules/cv_professional_analyzer');
